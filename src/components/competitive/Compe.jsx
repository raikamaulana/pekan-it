...
export default function Compe() {
    ...
    const sheetDataURL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSYPCJbwWseJ7W1owcOtzh7ryRwheFARmgsRLRtbkNzZUArMOMWvvymDxVW7DBdt08a4E2lb8j66EDH/pub?gid=135983079&single=true&output=csv';
    ...
    return (
        <>
            <div className="px-7 sm:px-16 lg:px-20 bg-mainBlack font-oxanium">    
                {/* <!-- Form Wrapper --> */}
                <form id="form-pendaftaran-cp" name="form-pendaftaran-cp" action="" method="post" encType="multipart/form-data">
                    {/* <!-- Section 3: Data Diri --> */}
                        ...
                        <div className='flex justify-center mt-11 md:mt-13 lg:mt-15 font-oxanium'>
                            <div className="z-1 flex flex-col gap-6 sm:gap-7 lg:gap-8 w-full items-center max-w-[1000px] text-white">
                                <span className="w-full flex flex-col gap-2 sm:gap-3 lg:gap-4">
                                    ...
                                    <input type="text" name="nama" id="Nama" placeholder='Marl Scotts' required className='rounded-full w-full border-none bg-white text-black text-lg sm:text-xl lg:text-2xl font-medium px-4 py-3 sm:px-5 sm:py-4 lg:px-6 lg:py-4 placeholder:text-slate-300 hover:placeholder:text-slate-400 placeholder:italic focus:ring-3 md:focus:ring-4 focus:ring-[#BD63D1] focus:outline-none transition-all duration-300' />
                                </span>
                                <span className="w-full flex flex-col gap-2 sm:gap-3 lg:gap-4">
                                    <label htmlFor="NoTelepon" className="text-lg sm:text-xl lg:text-2xl">No. WhatsApp :</label>
                                    <input type="text" name="no_telepon" id="NoTelepon" placeholder='0895xxxxxxxx' required className='rounded-full w-full border-none bg-white text-black text-lg sm:text-xl lg:text-2xl font-medium px-4 py-3 sm:px-5 sm:py-4 lg:px-6 lg:py-4 placeholder:text-slate-300 hover:placeholder:text-slate-400 placeholder:italic focus:ring-3 md:focus:ring-4 focus:ring-[#BD63D1] focus:outline-none transition-all duration-300' />
                                </span>
                                <span className="w-full flex flex-col gap-2 sm:gap-3 lg:gap-4">
                                    <label htmlFor="Institusi" className="text-lg sm:text-xl lg:text-2xl">Asal Institusi :</label>
                                    <input type="text" name="institusi" id="Institusi" placeholder='Universitas Singaperbangsa Karawang' required className='rounded-full w-full border-none bg-white text-black text-lg sm:text-xl lg:text-2xl font-medium px-4 py-3 sm:px-5 sm:py-4 lg:px-6 lg:py-4 placeholder:text-slate-300 hover:placeholder:text-slate-400 placeholder:italic focus:ring-3 md:focus:ring-4 focus:ring-[#BD63D1] focus:outline-none transition-all duration-300' />
                                </span>
                                <span className="w-full flex flex-col gap-2 sm:gap-3 lg:gap-4">
                                    <label htmlFor="Angkatan" className="text-lg sm:text-xl lg:text-2xl">Angkatan :</label>
                                    <input type="number" name="angkatan" id="Angkatan" placeholder='2024' required className='rounded-full w-full border-none bg-white text-black text-lg sm:text-xl lg:text-2xl font-medium px-4 py-3 sm:px-5 sm:py-4 lg:px-6 lg:py-4 placeholder:text-slate-300 hover:placeholder:text-slate-400 placeholder:italic focus:ring-3 md:focus:ring-4 focus:ring-[#BD63D1] focus:outline-none transition-all duration-300' />
                                </span>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="mt-35 md:mt-40 xl:mt-45 relative flex flex-col text-white text-center justify-center items-center selection:bg-purple-900 selection:text-white">
                        ...
                        <div className="w-full flex flex-col items-center gap-12 mt-12 z-1 max-w-[300px] sm:max-w-[350px] md:max-w-[500px]">
                            ...
                            <div className="flex flex-col md:flex-row items-center gap-4 justify-center w-full md:mt-8 mb-25 sm:mb-30 lg:mb-40 transition-all duration-500">
