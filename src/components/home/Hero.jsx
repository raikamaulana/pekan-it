                ...
                <section id="hero" className="h-screen flex justify-center items-center bg-mainBlack blue-300 transition-all duration-500 px-10 md:px-0 relative " style={{ backgroundImage:"url('/bg/starry-sky.png')" }}>
                    ...
                    <div className="font-oxanium z-3">
                        ...
                        <button 
                            ...
                            className="button flex items-center gap-2 px-6 py-3 border-none origin-center relative cursor-pointer mt-7 md:mt-12 font-jakarta mx-auto z-5">
                            ...
                            <span className="text_button selection:bg-purple-900 selection:text-white">Yuk, Daftar!</span>
                        </button>
                    </div>
                </section>
                {/* Hero Section */}
