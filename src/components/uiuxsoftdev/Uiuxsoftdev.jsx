...
export default function Uiuxsoftdev() {
    ...
    const sheetDataURL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSYPCJbwWseJ7W1owcOtzh7ryRwheFARmgsRLRtbkNzZUArMOMWvvymDxVW7DBdt08a4E2lb8j66EDH/pub?output=csv';
        ...
        const uploadFormData = (formData) => {
            ...
            Promise.all(filePromises)
                ...
                if (data.result === 'success') {
                    ...
                    router.push(`/terimakasih?jenis=${encodeURIComponent(selectedEvent)}`);
                    // router.push(`/terimakasih`);
                    }, 100);
                    form.reset();
                } else if (data.result === 'duplicate') {
                    alert("Data duplikat. Mohon gunakan nama tim & ketua tim yang berbeda.");
                } else {
            ...
            fetch(sheetDataURL)
                ...
                .then(csvText => {
                    ...
                    const isDuplicate = rows.some((row, i) => {
                        if (i === 0) return false;
                        const namaTimData = row[namaTimIndex]?.trim().toLowerCase();
                        const leadTim = row[timLeadIndex]?.trim().toLowerCase();
                        return namaTimData === namaTim && leadTim === timLead;
                    });
    ...
    return (
        <>
            <div className="px-7 sm:px-16 lg:px-20 bg-mainBlack font-oxanium">
                {/* <!-- Form Wrapper --> */}
                <form id="form-pendaftaran-lomba" name ="form-pendaftaran-lomba" action="https://script.google.com/macros/s/AKfycbz1RGoiDB2eS9T-Dev5LHVWT0rPnSGVZNAU5vQwsrC_4t1jl4dX5xmMZ719FtI2whs/exec" method="post" encType="multipart/form-data">
                    {/* <!-- Section 2: Pilih Mata Lomba --> */}
                    <section className="pt-35 md:pt-40 xl:pt-45 relative flex flex-col text-white text-center justify-center items-center selection:bg-purple-900 selection:text-white">
                        <div className="absolute hidden md:block bottom-0 -right-20 w-[1px] h-[1px] rounded-full shadow-purple-glow z-0"></div>
                        <div className="absolute md:hidden -bottom-10 right-0 w-[1px] h-[1px] rounded-full shadow-purple-glow-mob-2"></div>
                        <div className="absolute hidden md:block bottom-20 left-20 w-[1px] h-[1px] rounded-full shadow-green-glow"></div>
                        <div className="absolute md:hidden bottom-70 left-20 w-[1px] h-[1px] rounded-full shadow-green-glow-mob"></div>
                        <div className="relative z-1 text-center text-white font-oxanium font-semibold text-4xl sm:text-5xl lg:text-6xl xl:text-7xl max-w-[800px] mb-10 sm:mb-15 lg:mb-20 transition-all duration-500">
                            <h1 className='shadow-text-2'>Pilih Mata Lomba</h1>
                        </div>
                        <div className="w-full max-w-[80%] sm:max-w-[70%] md:max-w-[850px] mx-auto gap-10 md:gap-[55px] lg:gap-[70px] grid grid-cols-1 md:grid-cols-2">
                            <label className="radio-card py-8 border-2 border-black rounded-[60px] bg-black select-none cursor-pointer z-1">
                                <input type="radio" name="event" value="uiux" />
                                <img src="/icons/uiux.png" alt="UI/UX" className='w-fit mx-auto h-[120px] sm:h-[140px] md:h-[160px] lg:h-[180px] mb-5 transition-all duration-500' />
                                <span className="font-bold text-3xl sm:text-4xl lg:text-5xl text-center text-white">UI/UX</span>
                            </label>
                            <label className="radio-card py-8 border-2 border-black rounded-[60px] bg-black select-none cursor-pointer z-1">
                                <input type="radio" name="event" value="softdev" />
                                <img src="/icons/sofdev.png" alt="Software Development" className='w-fit mx-auto h-[120px] sm:h-[140px] md:h-[160px] lg:h-[180px] mb-5 transition-all duration-500' />
                                <span className="font-bold text-3xl sm:text-4xl lg:text-5xl text-center text-white">Software Development</span>
                            </label>
                        </div>
                    </section>

                    {/* <!-- Section 3: Data Diri --> */}
                    <section className="pb-40 sm:pb-45 lg:pb-50 pt-25 selection:bg-purple-900 selection:text-white transition-all duration-500 relative">
                        <div className="absolute hidden md:block top-90 left-20 w-[1px] h-[1px] rounded-full shadow-purple-glow z-0"></div>
                        <div className="absolute md:hidden top-90 left-0 w-[1px] h-[1px] rounded-full shadow-purple-glow-mob-2"></div>
                        ...
                        <div className="flex justify-center mt-11 md:mt-13 lg:mt-15 font-oxanium">
                            <div className="z-1 flex flex-col gap-6 sm:gap-7 lg:gap-8 w-full items-center max-w-[1000px] text-white">
                                <span className="w-full flex flex-col gap-2 sm:gap-3 lg:gap-4">
                                    <label htmlFor="Nama" className="text-lg sm:text-xl lg:text-2xl">Nama Tim:</label>
                                    <input type="text" name="nama_tim" id="Nama" placeholder="Tim A" className='rounded-full w-full border-none bg-white text-black text-lg sm:text-xl lg:text-2xl font-medium px-4 py-3 sm:px-5 sm:py-4 lg:px-6 lg:py-4 placeholder:text-slate-300 hover:placeholder:text-slate-400 placeholder:italic focus:ring-3 md:focus:ring-4 focus:ring-[#BD63D1] focus:outline-none transition-all duration-300' required />
                                </span>
                                <span className="w-full flex flex-col gap-2 sm:gap-3 lg:gap-4">
                                    <label htmlFor="Anggota" className="text-lg sm:text-xl lg:text-2xl">Anggota Tim :</label>
                                    <input type="text" name="anggota_tim" id="Anggota" placeholder="Anggota 1, Anggota 2" className='rounded-full w-full border-none bg-white text-black text-lg sm:text-xl lg:text-2xl font-medium px-4 py-3 sm:px-5 sm:py-4 lg:px-6 lg:py-4 placeholder:text-slate-300 hover:placeholder:text-slate-400 placeholder:italic focus:ring-3 md:focus:ring-4 focus:ring-[#BD63D1] focus:outline-none transition-all duration-300' required />
                                </span>
                                <span className="w-full flex flex-col gap-2 sm:gap-3 lg:gap-4">
                                    <label htmlFor="TimLead" className="text-lg sm:text-xl lg:text-2xl">Nama Ketua Tim :</label>
                                    <input type="text" name="tim_lead" id="TimLead" placeholder="Ketua tim" className='rounded-full w-full border-none bg-white text-black text-lg sm:text-xl lg:text-2xl font-medium px-4 py-3 sm:px-5 sm:py-4 lg:px-6 lg:py-4 placeholder:text-slate-300 hover:placeholder:text-slate-400 placeholder:italic focus:ring-3 md:focus:ring-4 focus:ring-[#BD63D1] focus:outline-none transition-all duration-300' required />
                                </span>
                                <span className="w-full flex flex-col gap-2 sm:gap-3 lg:gap-4">
                                    <label htmlFor="NoTelepon" className="text-lg sm:text-xl lg:text-2xl">No. Telepon Ketua Tim :</label>
                                    <input type="text" name="no_telepon" id="NoTelepon" placeholder="08XX-XXXX-XXXX" className='rounded-full w-full border-none bg-white text-black text-lg sm:text-xl lg:text-2xl font-medium px-4 py-3 sm:px-5 sm:py-4 lg:px-6 lg:py-4 placeholder:text-slate-300 hover:placeholder:text-slate-400 placeholder:italic focus:ring-3 md:focus:ring-4 focus:ring-[#BD63D1] focus:outline-none transition-all duration-300' required />
                                </span>
                                <span className="w-full flex flex-col gap-2 sm:gap-3 lg:gap-4">
                                    <label htmlFor="Institusi" className="text-lg sm:text-xl lg:text-2xl">Asal Institusi :</label>
                                    <input type="text" name="institusi" id="Institusi" placeholder="Institusi" className='rounded-full w-full border-none bg-white text-black text-lg sm:text-xl lg:text-2xl font-medium px-4 py-3 sm:px-5 sm:py-4 lg:px-6 lg:py-4 placeholder:text-slate-300 hover:placeholder:text-slate-400 placeholder:italic focus:ring-3 md:focus:ring-4 focus:ring-[#BD63D1] focus:outline-none transition-all duration-300' required />
                                </span>
                                <span className="w-full flex flex-col gap-2 sm:gap-3 lg:gap-4">
                                    <label htmlFor="Angkatan" className="text-lg sm:text-xl lg:text-2xl">Angkatan :</label>
                                    <input type="number" name="angkatan" id="Angkatan" placeholder="Contoh: 23" className='rounded-full w-full border-none bg-white text-black text-lg sm:text-xl lg:text-2xl font-medium px-4 py-3 sm:px-5 sm:py-4 lg:px-6 lg:py-4 placeholder:text-slate-300 hover:placeholder:text-slate-400 placeholder:italic focus:ring-3 md:focus:ring-4 focus:ring-[#BD63D1] focus:outline-none transition-all duration-300' required />
                                </span>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="relative flex flex-col text-white text-center justify-center items-center selection:bg-purple-900 selection:text-white">
                        <div className="absolute hidden md:block top-30 -right-10 w-[1px] h-[1px] rounded-full shadow-purple-glow z-0"></div>
                        <div className="absolute md:hidden top-0 right-5 w-[1px] h-[1px] rounded-full shadow-purple-glow-mob-2"></div>
                        <div className="absolute hidden md:block bottom-20 left-20 w-[1px] h-[1px] rounded-full shadow-green-glow"></div>
                        <div className="absolute md:hidden bottom-40 left-20 w-[1px] h-[1px] rounded-full shadow-green-glow-mob"></div>
                        <div className="z-1 text-center text-white font-oxanium font-semibold text-4xl sm:text-5xl lg:text-6xl xl:text-7xl max-w-[800px] mb-10 sm:mb-15 lg:mb-20 transition-all duration-500">
                            <h1 className='shadow-text-2'>Syarat Mengikuti Perlombaan</h1>
                        </div>
                        <div className="flex flex-col items-center gap-15 md:gap-17 lg:gap-20 w-full z-1 transition-all duration-500">
                            ...
                            <span className="w-full flex flex-col items-center gap-5 md:gap-8 lg:gap-10">
                                ...
                                <div className="flex justify-center items-center gap-4 flex-wrap">
                                    ...
                                    <span id="upload-success-story" className="ml-4 text-2xl text-green-500 font-semibold" style={{display: "none"}}>
                                        ✅ Berhasil diunggah!
                                    </span>
                    ...
                    <section className="mt-35 md:mt-40 xl:mt-45 relative flex flex-col text-white text-center justify-center items-center selection:bg-purple-900 selection:text-white">
                        ...
                        <div className="w-full max-w-[80%] sm:max-w-[70%] md:max-w-[850px] mx-auto gap-10 md:gap-[55px] lg:gap-[70px] grid grid-cols-1 md:grid-cols-2">
                            <label className="radio-card py-8 border-2 border-black rounded-[60px] bg-black select-none cursor-pointer z-1">
                                ...
                                <img src="/logo/Dana.svg" alt="Dana" className='w-fit mx-auto h-[120px] sm:h-[140px] md:h-[160px] lg:h-[180px] mb-5 transition-all duration-500' />
                            ...
                            <label className="radio-card py-8 border-2 border-black rounded-[60px] bg-black select-none cursor-pointer z-1">
                                ...
                                <img src="/logo/SeaBank.svg" alt="Seabank" className='w-fit mx-auto h-[120px] sm:h-[140px] md:h-[160px] lg:h-[180px] mb-5 transition-all duration-500' />
                        ...
                        <div className="w-full flex flex-col items-center gap-12 mt-12 z-1 max-w-[300px] sm:max-w-[350px] md:max-w-[500px]">
                            ...
                            <div className="flex flex-col md:flex-row items-center gap-4 justify-center w-full md:mt-8 mb-30 mt-10 lg:mt-5 sm:mb-35 lg:mb-40 transition-all duration-500">
                        ...
                        <div className="absolute hidden md:block bottom-80 right-20 w-[1px] h-[1px] rounded-full shadow-green-glow"></div>
                        <div className="absolute md:hidden bottom-60 right-20 w-[1px] h-[1px] rounded-full shadow-green-glow-mob"></div>
                    </section>
                </form>
                {/* <!-- End of Form --> */}
            </div>
