...
export default function Webinar() {
    ...
    const scriptURL = 'https://script.google.com/macros/s/AKfycbwwFZxI9sfvdzHIPR87h0PtuOF5sipB8NmebxwT45B7P9KniVRGvYgOIWFmYeJPMH5X/exec';
    const sheetDataURL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSYPCJbwWseJ7W1owcOtzh7ryRwheFARmgsRLRtbkNzZUArMOMWvvymDxVW7DBdt08a4E2lb8j66EDH/pub?gid=410549343&single=true&output=csv';
    ...
    return (
        <>
            <div className="px-7 sm:px-16 lg:px-20 bg-mainBlack font-oxanium">
                {/* <!-- Form Wrapper --> */}
                <form id="form-pendaftaran-webinar" name="form-pendaftaran-webinar" action="" method="post" encType="multipart/form-data">
                    {/* <!-- Section 3: Data Diri --> */}
                    ...
                    <section className="relative flex flex-col text-white text-center justify-center items-center selection:bg-purple-900 selection:text-white">
                        <div className="z-1 text-center text-white font-oxanium font-semibold text-4xl sm:text-5xl lg:text-6xl xl:text-7xl max-w-[800px] mb-10 sm:mb-15 lg:mb-20 transition-all duration-500">
                            <h1 className='shadow-text-2'>Syarat Mengikuti Webinar</h1>
                        </div>
                        <div className="flex flex-col items-center gap-15 md:gap-17 lg:gap-20 w-full z-1 transition-all duration-500">
                            ...
                            <div className="w-full max-w-[300px] sm:max-w-[350px] md:max-w-[500px] flex flex-col md:flex-row items-center gap-5 justify-center md:mt-8 mb-30 sm:mb-35 lg:mb-40 transition-all duration-500">
